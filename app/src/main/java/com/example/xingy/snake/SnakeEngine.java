package com.example.xingy.snake;
...
public class SnakeEngine extends SurfaceView implements Runnable {
    ...
    public SnakeEngine(Context context, Point size) {
        ...
        try {
            ...
            bite1 = soundPool.load(descriptor, 0);
    ...
    private void eatBob() {
        ...
        //add to the score
        score = score + 1;
        soundPool.play(bite1, 1, 1, 0, 0, 1);
    }
    ...
    private void moveSnake() {
        ...
        for (int i = snakeLength; i > 0; i--) {
            ...
            //to the positionof the segment in front of it
    ...
    public void draw() {
        ...
        if (surfaceHolder.getSurface().isValid()) {
            ...
            //Fill the screen with the colour blue
    ...
    public boolean updateRequired() {
        //Are we due to the update the frame
        if (nextFrameTime <= System.currentTimeMillis()) {
            //tenth of a second has passed

            //set up when the next update will be triggered
            nextFrameTime = System.currentTimeMillis() * MILLIS_PER_SECOND / FPS;
            //Return true so that the update and draw
            //Functions ar executed
            return true;
        }
        return false;
    }
